...
import com.edureka.pages.EdurekaPageToLoginPOMStyle;
import com.edureka.pages.EdurekaPaymentPage;
...
public class BaseSetup {
    ...
    protected EdurekaPageToLoginPOMStyle pageToLogin;
    protected EdurekaLoginDetailsPage loginDetails;
    protected EdurekaHomePage edurekaHomePage;
    protected EdurekaSearchCourseResultPage searchCoursePage;
    protected EdurekaCourseDetailsPage courseDetailspage;
    protected EdurekaCourseCheckout courseCheckout;
    protected EdurekaPaymentPage paymentPage;
	...
	public void setup() throws Exception {
		...
		searchCourseType = configProperty.getProperty("searchCourseType");
		...
		pageToLogin = new EdurekaPageToLoginPOMStyle(driver);
		paymentPage = new EdurekaPaymentPage(driver);
